...
public class Snake extends JPanel {
    ...
    /* Stores the snake body, 0 index is the head*/
    private int Direction = Define.UP; // Store direction
    private SNode foodNode = new SNode(1, 1, Color.BLACK);
    /* Node which holds info on the food */
    ...
    /*ImageIcon for the snake's head*/
    // Added
    ...
    /**
     * Default constructor for Snake game. Creates a snake. Spawns a food node.
     */
    public Snake() {
        initSnake();
    ...
    public void run(AlgorithmEnum algorithm) {        
        ...
        while (isGameOn) {            
            Algorithm ai = new FactoryAlgorithm(snk).getInstance(algorithm);
            ai.execute();
        }
